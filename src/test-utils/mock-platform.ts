...
export function createMockPlatform(overrides: Partial<Platform> = {}): Platform {
  return {
    ...
    initSubTabButtonsOverlay: vi.fn(),
    showSubTabButtons: vi.fn(),
    hideSubTabButtons: vi.fn(),
    initSubTabAnimationOverlay: vi.fn(),
    playSubTabEnterAnimation: vi.fn(async () => ({ originX: 0, originY: 0 })),
    playSubTabExitAnimation: vi.fn(async () => {}),
    showSubTabOverlay: vi.fn(),
    hideSubTabOverlay: vi.fn(),
    updateSubTabOverlayFrame: vi.fn(),
    setSubTabOverlayPassthrough: vi.fn(),
